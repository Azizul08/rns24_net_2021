...
<div class="post-sidebar-area right-sidebar mt-30 mb-30 box-shadow">
    ...
    <div class="single-sidebar-widget p-30">
        ...
        <div class="social-followers-info">
            ...
            <!-- YouTube -->
            <a href="#" class="youtube-subscribers"><i class="fa fa-youtube"></i>  <span>Subscribers</span></a>
        </div>
    </div>
...
<?php echo $__env->make('frontend.include.sidebarnewsletter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<<<<<<<<<<<<<<<<<<<<< --><?php /**PATH C:\xampp\htdocs\laravel\rns\resources\views/frontend/include/rightcard.blade.php ENDPATH**/ ?>