<aside class="left-sidebar" data-sidebarbg="skin5">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('email.show')); ?>" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('title.show')); ?>" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item ml-3">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('deletednews.show')); ?>" aria-expanded="false">
                                <i class="mdi mdi-receipt"></i>
                        ...
                        <!-- deleted news page start-->
                        <li class="sidebar-item ml-3">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo e(route('news.gallery')); ?>" aria-expanded="false">
                                <i class="mdi mdi-receipt"></i>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/rns24/public_html/resources/views/backend/include/leftSideBar.blade.php ENDPATH**/ ?>