...
<html lang="en">
    ...
    <body>
        ...
        <marquee behavior="" direction="" class="text-slide">
            <ul>
            <?php $__currentLoopData = App\Models\Backend\News\News::orderBy('id','desc')->where('is_delete',0)->where('status',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\laravel Project\rns24\resources\views/frontend/template/layout.blade.php ENDPATH**/ ?>