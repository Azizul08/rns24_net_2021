    ...
    <?php echo $__env->make('frontend.include.leftcard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     ...
     <div class="mag-posts-content mt-30 mb-30 p-30 box-shadow">
                            ...
                            <div class="single--slide">
                                ...
                                <div class="single-blog-post d-flex style-3">
                                    <div class="post-thumbnail">
                                        <?php if( $news->image == NULL ): ?>
                                        <a href="<?php echo e(route('newsdetail', $news->id)); ?>" target="blank">
                                            <img src="<?php echo e(asset('images/news/thumbnail.png')); ?>" alt="">
                                        </a>
                                        <?php else: ?>
                                        <a href="<?php echo e(route('newsdetail', $news->id)); ?>" target="blank">
        ...
        <div class="row">
            ...
            <?php $__currentLoopData = App\Models\Backend\Category\Category::orderBy('id','desc')->where('is_delete',0)->take(11)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="single-featured-post">
                                ...
                                <div class="post-thumbnail mb-50">
                                    ...
                                    <?php endif; ?>
                                    <?php if( $news->video != NULL ): ?>
                                    <a class="<?php echo e(route('newsdetail', $news->id)); ?>"><i class="fa fa-play"></i></a>
                                    <?php endif; ?>
                                </div>
                                <!-- Post Contetnt -->
                                <div class="post-content">
...
<div class="single-sidebar-widget p-30">
    ...
    <!-- Single Blog Post -->
    <?php $__currentLoopData = App\Models\Backend\News\News::orderBy('id','desc')->where('is_pending',0)->where('is_delete',0)->where('status',1)->where('is_trend',1)->take(40)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<<<<<<<<<<<<<<<<<<<<< -->
 ...
 <!-- ##### Main Posts Area End ##### -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\rns24_net_2021\resources\views/frontend/pages/index.blade.php ENDPATH**/ ?>