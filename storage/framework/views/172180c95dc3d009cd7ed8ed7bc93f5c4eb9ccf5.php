                ...
                <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                    <div class="sidebar-area bg-white mb-30 box-shadow">
                        ...
                        <div class="single-sidebar-widget p-30">
                            ...
                            <?php if( $i == 0 ): ?>
                            <a href="<?php echo e($ad->link); ?>" class="add-img" style="margin-top: 15px; display: inline-block;"><img src="<?php echo e(asset('images/ad/'. $ad->image)); ?>" alt=""></a>
                            <?php endif; ?>
                            <?php
                            $i--;
                            ?>
...
<?php echo $__env->make('frontend.template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel Project\rns24\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>