...
<script src="<?php echo e(asset('frontend/js/fencybox.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/js/fency.js')); ?>"></script>
<!-- All Plugins js -->
<script src="<?php echo e(asset('frontend/js/plugins/plugins.js')); ?>"></script>
<!-- Active js -->
<script src="<?php echo e(asset('frontend/js/active.js')); ?>"></script><?php /**PATH /home/rns24/public_html/resources/views/frontend/include/script.blade.php ENDPATH**/ ?>