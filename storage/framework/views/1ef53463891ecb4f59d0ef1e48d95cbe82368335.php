...
<!-- rich text editor -->
<script src="<?php echo e(asset('backend/dist/js/all_plugins.js')); ?>"></script>
<script src="<?php echo e(asset('backend/dist/js/rte.js')); ?>"></script>
<script src="<?php echo e(asset('backend/js/choosen.min.js')); ?>"></script>
...
<?php echo $__env->yieldContent('per_page_js'); ?><?php /**PATH /home/rns24/public_html/resources/views/backend/include/script.blade.php ENDPATH**/ ?>