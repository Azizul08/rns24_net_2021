                            ...
                            <div class="modal fade" id="addad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo e(route('ad.store')); ?>" method="POST" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                ...
                                <table id="ad" class="table table-bordered table-hover text-center align-item-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <img src="<?php echo e(asset('images/ad/' . $ad->image )); ?>" class="img-fluid" width="50px"  alt="">
                                            </td>
                                            <td>
                                                    <?php echo e($ad->link); ?>
                                            ...
                                            <td>
                                                ...
                                                <!-- edit modal start -->
                                                <button class="btn btn-primary" data-toggle="modal" data-target="#editad<?php echo e($ad->id); ?>">Edit</button>
                                                <!-- Modal -->
                                                <div class="modal fade" id="editad<?php echo e($ad->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                        <form action="<?php echo e(route('ad.update', $ad->id)); ?>" method="POST" enctype="multipart/form-data">
                                                            <?php echo csrf_field(); ?>
                                                                <div class="form-group">
                                                                    <label>Upload your site ad</label> <br>
                                                                    <img src="<?php echo e(asset('images/ad/' . $ad->image )); ?>" width="50px" alt=""> <br> <br>
                                                                    <input type="file" class="form-control-file" name="image">
                                                                </div>
                                                                <div class="form-group">
                                                <label>Link</label>
                                                <input type="text" class="form-control" name="link" value="<?php echo e($ad->link); ?>">
                                            </div>
                                                                <div class="form-group">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('superAdmin')): ?>
                                                <button class="btn btn-danger" data-toggle="modal" data-target="#deletead<?php echo e($ad->id); ?>">Delete</button>
                                                <?php endif; ?>
                                                <!-- Modal -->
                                                <div class="modal fade" id="deletead<?php echo e($ad->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                        <div class="modal-header">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('backend.template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rns24/public_html/resources/views/backend/pages/ad/manage.blade.php ENDPATH**/ ?>