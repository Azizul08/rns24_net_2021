                ...
                <div class="sidebar-area bg-white mb-30 box-shadow">
                    ...
                    <div class="single-sidebar-widget p-30">
                        ...
                        <div class="social-followers-info">
                            ...
                            <!-- YouTube -->
                            <a href="#" class="youtube-subscribers"><i class="fa fa-youtube"></i> </a>
                            <!-- Google -->
                            <a href="#" class="google-followers"><i class="fa fa-google-plus"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="single-sidebar-widget">
                        <a href="#" class="add-img"><img src="<?php echo e(asset('frontend/img/bg-img/add2.png')); ?>" alt=""></a>
                    </div>
...
<?php echo $__env->make('frontend.template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\rns\resources\views/frontend/pages/newsdetail.blade.php ENDPATH**/ ?>