        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center">
            <div class="auth-box border-top border-secondary">
                <div>
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" method="POST" action="<?php echo e(route('register.superadmin')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" placeholder="Email Address" aria-label="Username" aria-describedby="basic-addon1" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email">
...
unset($__errorArgs, $__bag); ?>" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" name="password" required autocomplete="new-password">
...
<?php /**PATH C:\xampp\htdocs\laravel Project\rns24\resources\views/auth/register.blade.php ENDPATH**/ ?>