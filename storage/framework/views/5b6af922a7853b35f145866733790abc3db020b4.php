                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-left">
                                 ...
                                 <div class="col-md-3 text-left" style="margin-top: 15px;">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="breaking" id="four" value="0" <?php if( $news->is_breakingNews == 0  ): ?>
                                                checked
                                                <?php endif; ?>>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('backend.template.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rns24/public_html/resources/views/backend/pages/news/editpendingnews.blade.php ENDPATH**/ ?>